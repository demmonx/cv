...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\Back\\MainController' => 'getMainControllerService.php',
            'App\\Controller\\Front\\LocaleSwitchController' => 'getLocaleSwitchControllerService.php',
            'App\\Controller\\Front\\MainController' => 'getMainController2Service.php',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'/src/EventListener/LocaleListener.php';
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.request', [0 => function () {
            return ($this->privates['App\\EventListener\\LocaleListener'] ?? ($this->privates['App\\EventListener\\LocaleListener'] = new \App\EventListener\LocaleListener('fr')));
        }, 1 => 'onKernelRequest'], 20);
        $instance->addListener('kernel.request', [0 => function () {
            return ($this->privates['app.locale_listener'] ?? ($this->privates['app.locale_listener'] = new \App\EventListener\LocaleListener()));
        }, 1 => 'onKernelRequest'], 20);
